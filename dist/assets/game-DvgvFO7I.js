import{BaseGame as r}from"./base-game-CFpGsXJM.js";import{StatisticsQuestionBank as n}from"./questions-CbWp0bxR.js";import"./auth-modal-BCGjUoIH.js";import"https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";import"https://www.gstatic.com/firebasejs/10.8.0/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";class o extends r{constructor(){super("Statistics Heist"),this.totalVaults=8,this.heat=3,this.vaultsCracked=0,this.mistakes=0,this.isPlaying=!1,this.currentQuestion=null,this.initUI()}initUI(){this.initDOM(),document.body.addEventListener("pointerdown",()=>this.initAudio(),{once:!0}),document.getElementById("btn-play-again").addEventListener("click",()=>{this.initAudio(),document.getElementById("report-modal").style.display="none",this.resetGame()});for(let t=0;t<4;t++){const e=document.getElementById(`btn-opt-${t}`);e.addEventListener("click",()=>{this.initAudio(),this.checkAnswer(e,e.dataset.correct==="true")})}this.resetGame()}initDOM(){const t=document.getElementById("game-mount");let e=this.settings.timer==="on"?`<div class="stat-box" id="game-timer" style="${this.settings.timerVisible==="hidden"?"visibility:hidden;":""}">00:00</div>`:"";t.innerHTML=`
